    ...
    return (
        <header className="h-20 bg-white/80 dark:bg-surface-900/80 backdrop-blur-md border-b border-surface-200 dark:border-surface-800 px-8 flex items-center justify-between sticky top-0 z-10">
            ...
            <div className="flex items-center space-x-4 ml-8">
                <button
                    onClick={toggleTheme}
                    className="p-2.5 bg-surface-100 dark:bg-surface-800 text-surface-600 dark:text-surface-400 rounded-xl hover:bg-surface-200 dark:hover:bg-surface-700 transition-colors"
                >
